...
# run from anywhere:
# conda install -n moe -y psutil

# cd /project/inniang/nanogpu/kpt_nanochat/nanochat
# sbatch -p bigTiger -w itiger06 --export=ALL,NANOCHAT_BASE_DIR=/project/inniang/.cache/nanochat,LD_PRELOAD=/home/inniang/miniconda3/envs/moe/lib/libittnotify.so slurm/itiger_smoke_base_train.sh
